        ...
        <div className="w-full max-w-md space-y-10">
          ...
          <div className="pt-4 border-t border-border-subtle">
            <button
              ...
              className="w-full h-[52px] bg-white text-primary border border-border-subtle rounded-xl font-bold hover:bg-surface transition-all duration-200 flex items-center justify-center gap-3 disabled:opacity-60"
            >
              <img
