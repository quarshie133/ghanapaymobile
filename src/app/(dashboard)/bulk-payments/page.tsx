...
export default function BulkPaymentsPage() {
  ...
  return (
    ...
    >
      <div className="p-4 rounded-xl bg-warning-container text-warning-dark text-sm mb-6 border border-warning/30">
        <strong>Not implemented yet.</strong> This page shows the intended bulk-payment flow with sample data for
        illustration — no real CSV file is parsed and no real transfers are sent. Building this for real needs CSV
        parsing, per-row recipient validation, and batch atomic transfers with partial-failure handling, none of
        which exist yet in this project.
      </div>
          ...
          {!uploaded && (
            <Card>
              ...
              <div
                ...
                title="Demo only — no file is actually read"
        ...
        <div className="col-span-12 lg:col-span-4 space-y-6">
          ...
          {!confirmed ? (
            <Btn
              variant="success"
              disabled
              className="w-full py-4 text-base font-bold flex items-center justify-center gap-2 opacity-50 cursor-not-allowed"
            >
