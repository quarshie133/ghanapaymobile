...
export default function SettingsPage() {
  ...
  async function handleSave() {
    try {
      await api.post('/users/update', { name, phone }); // email isn't editable here — see disabled field above
      setIsEditing(false);
            ...
            <div className="fade-in">
              ...
              <div className="two-col-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16, marginBottom: 24 }}>
                ...
                <Input
                  ...
                  disabled
                  hint="Email can't be changed here yet — it requires re-authentication for security. Contact support."
                />
              </div>
