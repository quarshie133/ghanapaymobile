    ...
    >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <Card className="lg:col-span-5 p-6">
          <h2 className="font-section-title text-section-title text-on-surface mb-2">Payment Methods</h2>
          <p className="text-xs text-outline mb-4">
            This sandbox only tracks the GhanaPay Wallet as a funding source — no card/bank/momo-specific breakdown is recorded.
          </p>
          {paymentMethods.length === 0 ? (
            <div className="text-secondary text-sm py-4">No spending this month yet.</div>
          ) : (
          <div className="space-y-6">
            {paymentMethods.map((m, i) => (
              <div key={i}>
      ...
      <div>
        <div className="flex items-center justify-between mb-4">
          <h2 className="font-section-title text-section-title text-on-surface">Savings Goals</h2>
        </div>
        <div className="p-4 rounded-xl bg-surface-container-low text-secondary text-sm mb-4">
          Savings goals aren't implemented yet in this sandbox — this section shows the intended layout with no fabricated data.
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div
            title="Savings goals aren't implemented yet"
            className="border-2 border-dashed border-border-subtle rounded-xl p-6 flex flex-col items-center justify-center text-outline min-h-[160px] opacity-60 cursor-not-allowed"
          >
            <span className="material-symbols-outlined text-3xl mb-2">
              add_circle
            </span>
            <span className="font-bold">Create New Goal (coming soon)</span>
          </div>
        </div>
      </div>
    </PageWrap>
