    ...
    >
      ...
      <div className="flex items-center gap-1 sm:gap-2 ml-auto shrink-0">
        ...
        <div className="flex items-center gap-2 pl-1">
          ...
          {/* Avatar image */}
          <div className="w-8 h-8 sm:w-9 sm:h-9 rounded-full overflow-hidden border-2 border-surface-container-low cursor-pointer hover:border-primary-fixed-dim transition-colors shrink-0">
            <img
